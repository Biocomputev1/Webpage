...
export const SubstackPosts = () => {
    return (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Left Card */}
          <div className="ml-4 border-2 border-purple-300 rounded-xl w-auto  h-auto overflow-hidden shadow-md transition delay-50 duration-500 ease-in-out hover:-translate-y-1 hover:scale-110 hover:shadow-lg">
          ...
          {/* Right Card */}
          <div className="mr-4 border-2 border-purple-300 bg-white rounded-xl overflow-hidden shadow-md transition delay-50 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110 hover:shadow-lg">
